...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#C94C40").s().p("AoRDEIQRmFQCag5BDgXQhIAdiUA3IoaDJIn3C8Qh1ArhXAfQBjgnBogng");
	this.shape.setTransform(45.775,73.55);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#C94C40","#FFFFFF"],[0,1],-6.5,0.1,6.6,-0.1).s().p("Ag2A3QAQgpALggQAJgaASgNIAggQQANgGATgFQgGADgZALQgJAFgVAKQgSAMgJAaIgaBJIgNAdg");
	this.shape_1.setTransform(-37.85,110.925);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E79B99").s().p("AEaKbIksq8IkYqMQhGilgohlQArBcBKCqIEZKOIErK7QBdDZAbBIQgohVhXjJg");
	this.shape_2.setTransform(-68.425,5.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#B9453B","#B8453B","#A73E35","#9C3A32","#983930"],[0,0.016,0.337,0.663,1],-82.5,1.4,82.6,-1.4).s().p("AsyFrIAth7QADgKAjgTIAtgSQACAEARgGQARgFADgIIW6ojQAHgCgFAGQgHAIgJADI3vI4QgRAGgDAHIgvB8QgCAFARgGIWcolIAGgBQAAABAAAAQAAAAAAABQAAAAAAABQAAAAAAABIgEAEQgHAEgFABI1cIOQABgFgRAGQgRAFgDAHIgXAJQgJAEgJACQgMADgGAAQgJAAACgHg");
	this.shape_3.setTransform(37.6254,83.1145);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D9D9C7").s().p("ArLEVQAKgjgLgVIW4okQg9AlgeAcQglAjgBAfI1WIMQAWgQAKgjg");
	this.shape_4.setTransform(38.8,81.95);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9E9087").s().p("AgKAnQAPgVAEgTQAEgUgBgSIgCgOIAFgCQANAPgBAeQgGAegTAXIgcANQAHgHAJgKg");
	this.shape_5.setTransform(-34.3963,109.575);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#8D8477","#050303"],[0,1],2.3,1.6,-3.1,-4.2).s().p("AgjAFIAKgXQAMgZALgDIAdgIIAFAJQAFAKgCANQgIArgaAaQgHAIgDAAg");
	this.shape_6.setTransform(-36.0942,109.675);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#D95246","#A83F36"],[0,1],-113,1.9,113.4,-2.1).s().p("Ax3seIUqkzIAGABIO/Z9IgEABI26Ikg");
	this.shape_7.setTransform(5.15,-9.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#A83F36","#BA463D","#CC4E44","#D75349","#DB554A"],[0,0.192,0.459,0.729,1],-1.2,0.6,1.7,-0.6).s().p("AGGPBIgEgCIsq9yQAFAFAOgEQALgDADgLIMwdwIgEAGIgOAHQgJAEgGAAIgCAAg");
	this.shape_8.setTransform(-70.075,6.5333);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#D95246","#D75145","#BD473D","#AE4138","#A83F36"],[0,0.027,0.412,0.749,1],-5.2,1.2,1.2,-1.5).s().p("AmLsuIgBgFIgCjIIMdd4IgtB7IAAAEg");
	this.shape_9.setTransform(-79.65,17.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#A83F36","#DA4D3D","#ECB3B3","#DA4D3D","#C94C40"],[0,0.251,0.455,0.761,1],-4.3,1.3,3.7,-2).s().p("Am3ulQgBgRAXgOQAWgNAXgBIMtd2QgSAHgUAJQgnASgGANg");
	this.shape_10.setTransform(-75.5005,9.175);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#C94C40","#C74C40","#993E36","#72322D","#522926","#392221","#271D1D","#1D1B1B","#1A1A1A"],[0,0.004,0.141,0.282,0.424,0.565,0.706,0.851,1],2.1,2.3,-3.7,-12.7).s().p("ArDEsIgqiJIXAnPIAbAwI2kIoIgIABQgBAAgBAAQgBAAgBAAQAAgBgBAAQAAAAAAAAg");
	this.shape_11.setTransform(29.85,88.3944);
...
p.nominalBounds = new cjs.Rectangle(-119.5,-120.1,239.1,240.3);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#567CBE").s().p("AoUDFIH6i9IIdjJQCxhCAtgPQguASivBCIwWGHQhrAnhjAkIDMhPg");
	this.shape.setTransform(46,73.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#567CBE","#FFFFFF"],[0,1],-6.5,0.1,6.6,-0.1).s().p("Ag2A3QAQgpALggQAJgaATgOIAfgQQAUgIAMgDQgGAEgZAKIgeAPQgSANgJAaIgbBJIgMAeg");
	this.shape_1.setTransform(-38.025,111.475);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A3BEE3").s().p("AEbKeIpH1PQhQi/gehMQAxBoBFCgIEaKQIEtK/QBXDNAhBVQgeg+hijhg");
	this.shape_2.setTransform(-68.775,5.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#4E73B8","#476AAB","#41629F","#3E5F9C"],[0,0.263,0.624,1],-82.9,1.4,83,-1.5).s().p("As2FtIAth8QADgGAPgLIAVgMIAVgJIAYgJQABAEARgGQASgFADgIIXBomQAHgCgFAGQgHAIgJADI33I7QgRAGgDAHIgvB9QgCAFARgGIWkooIAFgBQAAABABAAQAAAAAAABQAAAAgBABQAAAAAAABIgEAEIgLAGI1kIPQABgEgRAFQgRAGgDAHIgpAPQgMADgGAAQgJAAACgHg");
	this.shape_3.setTransform(37.8254,83.5023);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D9D9C7").s().p("ArOEWQAKgjgLgWIW/omQg9AlgfAcQglAkgBAeI1dIQQAWgQALgkg");
	this.shape_4.setTransform(38.975,82.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9E9087").s().p("AgKAnQAQgVAEgTQAEgUgCgSIgCgOIAGgCQAMARgBAcQgGAggTAVIgRAJIgLAEQAHgGAJgLg");
	this.shape_5.setTransform(-34.592,110.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#8D8477","#050303"],[0,1],2.4,1.6,-3,-4.2).s().p("AgjAFIAKgXQAMgYALgEIAdgIIAFAIQAFAMgCAMQgHArgbAbQgHAHgDAAg");
	this.shape_6.setTransform(-36.2714,110.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#6285C3","#466AAB"],[0,1],-113.6,1.9,114,-2.1).s().p("Ax9siIUxk0IAFABIPFaFIgFAAI3BIng");
	this.shape_7.setTransform(5.175,-9.6583);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#466AAB","#587BBB","#6386C4","#668AC7"],[0,0.333,0.667,1],-1.2,0.6,1.7,-0.6).s().p("AGIPFIgEgCIsu97QAFAFANgEQAMgDADgLIM0d6IgEAFIgOAHQgJAFgGAAIgCgBg");
	this.shape_8.setTransform(-70.425,6.5583);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#6285C3","#5A7DBD","#4B6FB0","#466AAB"],[0,0.188,0.655,1],-5.2,1.3,1.3,-1.4).s().p("AmNszIgBgEIgCjJIMheCIgtB8IAAADg");
	this.shape_9.setTransform(-80.05,17.85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#466AAB","#5F82C2","#B6CCEB","#5F82C2","#567CBE"],[0,0.251,0.455,0.761,1],-4.4,1.3,3.6,-2).s().p("Am6uqQAAgRAXgOQAVgNAYgBIMxeAIgmAQQgnASgHANg");
	this.shape_10.setTransform(-75.8755,9.225);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#567CBE","#4C6DA4","#3C537A","#303F57","#262F3C","#1F2329","#1B1C1E","#1A1A1A"],[0,0.082,0.231,0.38,0.533,0.686,0.839,1],2.1,2.4,-3.8,-12.7).s().p("ArHEtIgpiJIXGnSIAbAwI2qIsIgIABQgFAAgBgCg");
	this.shape_11.setTransform(30.025,88.8031);
...
p.nominalBounds = new cjs.Rectangle(-120.1,-120.7,240.3,241.5);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#74B94F").s().p("AoIDBIP/l+QC2hDAjgMQg4AWigA9Iv/F9IjIBJIDHhMg");
	this.shape.setTransform(44.95,72.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#74B94F","#FFFFFF"],[0,1],-6.4,0.1,6.4,-0.1).s().p("Ag1A2QAQgoAKggQAJgZASgOIAfgPQARgIAPgDQgGAEgZAKIgeAOQgRANgJAZQgKAggQAoIgMAdQACgKAHgUg");
	this.shape_1.setTransform(-37.175,109.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#ABD082").s().p("AEVKPIknqvIkSqBQhGijgmhjQAyBsBACXIEUKBIEnKvQBdDcAYBAQgkhKhZjPg");
	this.shape_2.setTransform(-67.25,5.625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#69AF50","#69AF50","#5E9C4A","#579047","#558C46"],[0,0.004,0.329,0.659,1],-81.1,1.4,81.1,-1.4).s().p("AskFmIAsh6QADgKAjgSIAUgJIAYgJQABAEARgFQARgGADgHIWgoaQAJgDgHAHQgGAHgKAEI3VIuQgQAGgDAHIguB5QgCAFAQgFIWEocQAEgBABABQABAAAAAAQAAAAAAABQAAAAAAABQgBAAAAABQgBACgDACQgGAEgFABI1EIEQABgEgRAFQgRAGgDAHIgoAOIgNADIgDAAQgKAAACgGg");
	this.shape_3.setTransform(37.0009,81.6229);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D9D9C7").s().p("Aq+EQQAJgigJgWIWdoZQg8AkgdAbQglAjgBAeI0+IDQAWgQAKgig");
	this.shape_4.setTransform(38.075,80.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9E9087").s().p("AgKAmQAQgVADgSQAEgUgBgRIgCgOIAGgCQAMAPgCAdQgGAggSAUIgRAJIgLAEQAIgHAIgKg");
	this.shape_5.setTransform(-33.8417,107.675);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#8D8477","#050303"],[0,1],2.3,1.6,-3,-4.1).s().p("AgiAFQAEgLAGgMQAMgYAKgDIAcgIIAGAIQAEALgCAMQgGApgbAbQgGAIgEAAg");
	this.shape_6.setTransform(-35.4692,107.775);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#82BE4E","#5E9D4C"],[0,1],-111,1.9,111.4,-2).s().p("AxjsQIUTktIAFABIOvZfIgEABI2gIag");
	this.shape_7.setTransform(5.025,-9.4083);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#5E9D4C","#68A64C","#79B44D","#84BD4E","#88C04E"],[0,0.133,0.424,0.71,1],-1.2,0.6,1.7,-0.6).s().p("AF/OwIgDgCIsd9RQAHAFAMgDQALgEADgKIMidOIgEAGQgDACgLAFQgKAEgGAAIgBAAg");
	this.shape_8.setTransform(-68.875,6.4525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#82BE4E","#72AF4D","#63A24C","#5E9D4C"],[0,0.306,0.702,1],-5,1.2,1.3,-1.4).s().p("AmEsgIgBgEIgCjFIMPdXIgsB5IAAADg");
	this.shape_9.setTransform(-78.275,17.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#5E9D4C","#85BF4E","#B8D797","#85BF4E","#74B94F"],[0,0.251,0.455,0.761,1],-4.3,1.3,3.6,-2).s().p("AmwuVQAAgQAWgOQAVgNAYgBIMedVQgSAHgTAJQgnASgGAMg");
	this.shape_10.setTransform(-74.1755,9.05);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#74B94F","#69A548","#507B3A","#3C582E","#2D3D25","#22291F","#1C1E1B","#1A1A1A"],[0,0.063,0.216,0.369,0.522,0.678,0.835,1],2.1,2.3,-3.7,-12.4).s().p("Aq3EmIgoiGIWlnHIAaAvI2KIfIgIABQgBAAgBAAQgBAAAAgBQgBAAAAAAQgBAAAAgBg");
	this.shape_11.setTransform(29.325,86.8818);
...
p.nominalBounds = new cjs.Rectangle(-117.4,-118,234.9,236);
...
if (reversed == null) { reversed = false; }
	...
	// Calque_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("AxBoMMAiDAAAIAAQZMgiDAAAg");
	this.shape.setTransform(0,0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(0,0,0,0.89)").ss(1,1,1).p("Ax7onMAj3AAAIAARPMgj3AAAg");
	this.shape_1.setTransform(0,0.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(0,0,0,0.776)").ss(1,1,1).p("Ay0pDMAlpAAAIAASHMglpAAAg");
	this.shape_2.setTransform(0,0.025);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(0,0,0,0.667)").ss(1,1,1).p("AzupfMAndAAAIAAS/MgndAAAg");
	this.shape_3.setTransform(0,0.025);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(0,0,0,0.557)").ss(1,1,1).p("A0np7MApPAAAIAAT3MgpPAAAg");
	this.shape_4.setTransform(0,0.05);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(0,0,0,0.443)").ss(1,1,1).p("A1hqWMArDAAAIAAUtMgrDAAAg");
	this.shape_5.setTransform(0,0.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("rgba(0,0,0,0.333)").ss(1,1,1).p("A2aqyMAs1AAAIAAVlMgs1AAAg");
	this.shape_6.setTransform(0,0.05);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("rgba(0,0,0,0.224)").ss(1,1,1).p("A3UrOMAupAAAIAAWdMgupAAAg");
	this.shape_7.setTransform(0,0.05);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("rgba(0,0,0,0.11)").ss(1,1,1).p("A4NrqMAwbAAAIAAXVMgwbAAAg");
	this.shape_8.setTransform(0,0.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1).p("A5HsFMAyPAAAIAAYLMgyPAAAg");
	...
	// Calque_1
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,1,1).p("AxBoMMAiDAAAIAAQZMgiDAAAg");
	this.shape_10.setTransform(0,0.025);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("rgba(0,0,0,0.89)").ss(1,1,1).p("Ax7onMAj3AAAIAARPMgj3AAAg");
	this.shape_11.setTransform(0,0.025);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("rgba(0,0,0,0.776)").ss(1,1,1).p("Ay0pDMAlpAAAIAASHMglpAAAg");
	this.shape_12.setTransform(0,0.025);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("rgba(0,0,0,0.667)").ss(1,1,1).p("AzupfMAndAAAIAAS/MgndAAAg");
	this.shape_13.setTransform(0,0.025);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("rgba(0,0,0,0.557)").ss(1,1,1).p("A0np7MApPAAAIAAT3MgpPAAAg");
	this.shape_14.setTransform(0,0.05);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("rgba(0,0,0,0.443)").ss(1,1,1).p("A1hqWMArDAAAIAAUtMgrDAAAg");
	this.shape_15.setTransform(0,0.025);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("rgba(0,0,0,0.333)").ss(1,1,1).p("A2aqyMAs1AAAIAAVlMgs1AAAg");
	this.shape_16.setTransform(0,0.05);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("rgba(0,0,0,0.224)").ss(1,1,1).p("A3UrOMAupAAAIAAWdMgupAAAg");
	this.shape_17.setTransform(0,0.05);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("rgba(0,0,0,0.11)").ss(1,1,1).p("A4NrqMAwbAAAIAAXVMgwbAAAg");
	this.shape_18.setTransform(0,0.05);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1).p("A5HsFMAyPAAAIAAYLMgyPAAAg");
	this.shape_19.setTransform(0,0.05);
...
p.nominalBounds = new cjs.Rectangle(-161.7,-78.3,323.5,156.8);


(lib.animation02 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// anim
	this.instance = new lib.DoorOpeningGreenScreenEffects_00000();

	this.instance_1 = new lib.DoorOpeningGreenScreenEffects_00001();

	this.instance_2 = new lib.DoorOpeningGreenScreenEffects_00002();

	this.instance_3 = new lib.DoorOpeningGreenScreenEffects_00003();

	this.instance_4 = new lib.DoorOpeningGreenScreenEffects_00004();

	this.instance_5 = new lib.DoorOpeningGreenScreenEffects_00005();

	this.instance_6 = new lib.DoorOpeningGreenScreenEffects_00006();

	this.instance_7 = new lib.DoorOpeningGreenScreenEffects_00007();

	this.instance_8 = new lib.DoorOpeningGreenScreenEffects_00008();

	this.instance_9 = new lib.DoorOpeningGreenScreenEffects_00009();

	this.instance_10 = new lib.DoorOpeningGreenScreenEffects_00010();

	this.instance_11 = new lib.DoorOpeningGreenScreenEffects_00011();

	this.instance_12 = new lib.DoorOpeningGreenScreenEffects_00012();

	this.instance_13 = new lib.DoorOpeningGreenScreenEffects_00013();

	this.instance_14 = new lib.DoorOpeningGreenScreenEffects_00014();

	this.instance_15 = new lib.DoorOpeningGreenScreenEffects_00015();

	this.instance_16 = new lib.DoorOpeningGreenScreenEffects_00016();

	this.instance_17 = new lib.DoorOpeningGreenScreenEffects_00017();

	this.instance_18 = new lib.DoorOpeningGreenScreenEffects_00018();

	this.instance_19 = new lib.DoorOpeningGreenScreenEffects_00019();

	this.instance_20 = new lib.DoorOpeningGreenScreenEffects_00020();

	this.instance_21 = new lib.DoorOpeningGreenScreenEffects_00021();

	this.instance_22 = new lib.DoorOpeningGreenScreenEffects_00022();

	this.instance_23 = new lib.DoorOpeningGreenScreenEffects_00023();

	this.instance_24 = new lib.DoorOpeningGreenScreenEffects_00024();

	this.instance_25 = new lib.DoorOpeningGreenScreenEffects_00025();

	this.instance_26 = new lib.DoorOpeningGreenScreenEffects_00026();

	this.instance_27 = new lib.DoorOpeningGreenScreenEffects_00027();

	this.instance_28 = new lib.DoorOpeningGreenScreenEffects_00028();

	this.instance_29 = new lib.DoorOpeningGreenScreenEffects_00029();

	this.instance_30 = new lib.DoorOpeningGreenScreenEffects_00030();

	this.instance_31 = new lib.DoorOpeningGreenScreenEffects_00031();

	this.instance_32 = new lib.DoorOpeningGreenScreenEffects_00032();

	this.instance_33 = new lib.DoorOpeningGreenScreenEffects_00033();

	this.instance_34 = new lib.DoorOpeningGreenScreenEffects_00034();

	this.instance_35 = new lib.DoorOpeningGreenScreenEffects_00035();

	this.instance_36 = new lib.DoorOpeningGreenScreenEffects_00036();

	this.instance_37 = new lib.DoorOpeningGreenScreenEffects_00037();

	this.instance_38 = new lib.DoorOpeningGreenScreenEffects_00038();

	this.instance_39 = new lib.DoorOpeningGreenScreenEffects_00039();
	...
	// bg
	this.instance_40 = new lib.WallWoodBG();
	this.instance_40.setTransform(0,0,0.8276,1.3334);
	this.instance_40._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(29).to({_off:false},0).wait(11));
...
(lib.book03_floating = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,y:-20},14).wait(16));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,y:20},15).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-119.5,-140.1,239.1,280.29999999999995);


(lib.book03_btn = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#C94C40").s().p("AoRDEIQRmFQCag5BDgXQhIAdiUA3IoaDJIn3C8Qh1ArhXAfQBjgnBogng");
	this.shape.setTransform(45.775,93.55);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#C94C40","#FFFFFF"],[0,1],-6.5,0.1,6.6,-0.1).s().p("Ag2A3QAQgpALggQAJgaASgNIAggQQANgGATgFQgGADgZALQgJAFgVAKQgSAMgJAaIgaBJIgNAdg");
	this.shape_1.setTransform(-37.85,130.925);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E79B99").s().p("AEaKbIksq8IkYqMQhGilgohlQArBcBKCqIEZKOIErK7QBdDZAbBIQgohVhXjJg");
	this.shape_2.setTransform(-68.425,25.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#B9453B","#B8453B","#A73E35","#9C3A32","#983930"],[0,0.016,0.337,0.663,1],-82.5,1.4,82.6,-1.4).s().p("AsyFrIAth7QADgKAjgTIAtgSQACAEARgGQARgFADgIIW6ojQAHgCgFAGQgHAIgJADI3vI4QgRAGgDAHIgvB8QgCAFARgGIWcolIAGgBQAAABAAAAQAAAAAAABQAAAAAAABQAAAAAAABIgEAEQgHAEgFABI1cIOQABgFgRAGQgRAFgDAHIgXAJQgJAEgJACQgMADgGAAQgJAAACgHg");
	this.shape_3.setTransform(37.6254,103.1145);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D9D9C7").s().p("ArLEVQAKgjgLgVIW4okQg9AlgeAcQglAjgBAfI1WIMQAWgQAKgjg");
	this.shape_4.setTransform(38.8,101.95);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9E9087").s().p("AgKAnQAPgVAEgTQAEgUgBgSIgCgOIAFgCQANAPgBAeQgGAegTAXIgcANQAHgHAJgKg");
	this.shape_5.setTransform(-34.3963,129.575);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#8D8477","#050303"],[0,1],2.3,1.6,-3.1,-4.2).s().p("AgjAFIAKgXQAMgZALgDIAdgIIAFAJQAFAKgCANQgIArgaAaQgHAIgDAAg");
	this.shape_6.setTransform(-36.0942,129.675);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#D95246","#A83F36"],[0,1],-113,1.9,113.4,-2.1).s().p("Ax3seIUqkzIAGABIO/Z9IgEABI26Ikg");
	this.shape_7.setTransform(5.15,10.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#A83F36","#BA463D","#CC4E44","#D75349","#DB554A"],[0,0.192,0.459,0.729,1],-1.2,0.6,1.7,-0.6).s().p("AGGPBIgEgCIsq9yQAFAFAOgEQALgDADgLIMwdwIgEAGIgOAHQgJAEgGAAIgCAAg");
	this.shape_8.setTransform(-70.075,26.5333);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#D95246","#D75145","#BD473D","#AE4138","#A83F36"],[0,0.027,0.412,0.749,1],-5.2,1.2,1.2,-1.5).s().p("AmLsuIgBgFIgCjIIMdd4IgtB7IAAAEg");
	this.shape_9.setTransform(-79.65,37.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#A83F36","#DA4D3D","#ECB3B3","#DA4D3D","#C94C40"],[0,0.251,0.455,0.761,1],-4.3,1.3,3.7,-2).s().p("Am3ulQgBgRAXgOQAWgNAXgBIMtd2QgSAHgUAJQgnASgGANg");
	this.shape_10.setTransform(-75.5005,29.175);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#C94C40","#C74C40","#993E36","#72322D","#522926","#392221","#271D1D","#1D1B1B","#1A1A1A"],[0,0.004,0.141,0.282,0.424,0.565,0.706,0.851,1],2.1,2.3,-3.7,-12.7).s().p("ArDEsIgqiJIXAnPIAbAwI2kIoIgIABQgBAAgBAAQgBAAgBAAQAAgBgBAAQAAAAAAAAg");
	this.shape_11.setTransform(29.85,108.3944);

	this.instance = new lib.book03_floating();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.instance}]},1).wait(3));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-119.5,-100.1,239.1,240.29999999999998);


(lib.book02_floating = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-120.1,-140.7,240.3,281.5);


(lib.book02_btn = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#567CBE").s().p("AoUDFIH6i9IIdjJQCxhCAtgPQguASivBCIwWGHQhrAnhjAkIDMhPg");
	this.shape.setTransform(46,93.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#567CBE","#FFFFFF"],[0,1],-6.5,0.1,6.6,-0.1).s().p("Ag2A3QAQgpALggQAJgaATgOIAfgQQAUgIAMgDQgGAEgZAKIgeAPQgSANgJAaIgbBJIgMAeg");
	this.shape_1.setTransform(-38.025,131.475);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#A3BEE3").s().p("AEbKeIpH1PQhQi/gehMQAxBoBFCgIEaKQIEtK/QBXDNAhBVQgeg+hijhg");
	this.shape_2.setTransform(-68.775,25.725);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#4E73B8","#476AAB","#41629F","#3E5F9C"],[0,0.263,0.624,1],-82.9,1.4,83,-1.5).s().p("As2FtIAth8QADgGAPgLIAVgMIAVgJIAYgJQABAEARgGQASgFADgIIXBomQAHgCgFAGQgHAIgJADI33I7QgRAGgDAHIgvB9QgCAFARgGIWkooIAFgBQAAABABAAQAAAAAAABQAAAAgBABQAAAAAAABIgEAEIgLAGI1kIPQABgEgRAFQgRAGgDAHIgpAPQgMADgGAAQgJAAACgHg");
	this.shape_3.setTransform(37.8254,103.5023);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D9D9C7").s().p("ArOEWQAKgjgLgWIW/omQg9AlgfAcQglAkgBAeI1dIQQAWgQALgkg");
	this.shape_4.setTransform(38.975,102.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9E9087").s().p("AgKAnQAQgVAEgTQAEgUgCgSIgCgOIAGgCQAMARgBAcQgGAggTAVIgRAJIgLAEQAHgGAJgLg");
	this.shape_5.setTransform(-34.592,130.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#8D8477","#050303"],[0,1],2.4,1.6,-3,-4.2).s().p("AgjAFIAKgXQAMgYALgEIAdgIIAFAIQAFAMgCAMQgHArgbAbQgHAHgDAAg");
	this.shape_6.setTransform(-36.2714,130.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#6285C3","#466AAB"],[0,1],-113.6,1.9,114,-2.1).s().p("Ax9siIUxk0IAFABIPFaFIgFAAI3BIng");
	this.shape_7.setTransform(5.175,10.3417);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#466AAB","#587BBB","#6386C4","#668AC7"],[0,0.333,0.667,1],-1.2,0.6,1.7,-0.6).s().p("AGIPFIgEgCIsu97QAFAFANgEQAMgDADgLIM0d6IgEAFIgOAHQgJAFgGAAIgCgBg");
	this.shape_8.setTransform(-70.425,26.5583);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#6285C3","#5A7DBD","#4B6FB0","#466AAB"],[0,0.188,0.655,1],-5.2,1.3,1.3,-1.4).s().p("AmNszIgBgEIgCjJIMheCIgtB8IAAADg");
	this.shape_9.setTransform(-80.05,37.85);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#466AAB","#5F82C2","#B6CCEB","#5F82C2","#567CBE"],[0,0.251,0.455,0.761,1],-4.4,1.3,3.6,-2).s().p("Am6uqQAAgRAXgOQAVgNAYgBIMxeAIgmAQQgnASgHANg");
	this.shape_10.setTransform(-75.8755,29.225);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#567CBE","#4C6DA4","#3C537A","#303F57","#262F3C","#1F2329","#1B1C1E","#1A1A1A"],[0,0.082,0.231,0.38,0.533,0.686,0.839,1],2.1,2.4,-3.8,-12.7).s().p("ArHEtIgpiJIXGnSIAbAwI2qIsIgIABQgFAAgBgCg");
	this.shape_11.setTransform(30.025,108.8031);

	this.instance = new lib.book02_floating();
...
p.nominalBounds = new cjs.Rectangle(-120.1,-100.7,240.3,241.5);


(lib.book01_floating = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-117.4,-138,234.9,276);


(lib.book01_btn = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#74B94F").s().p("AoIDBIP/l+QC2hDAjgMQg4AWigA9Iv/F9IjIBJIDHhMg");
	this.shape.setTransform(44.95,92.275);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#74B94F","#FFFFFF"],[0,1],-6.4,0.1,6.4,-0.1).s().p("Ag1A2QAQgoAKggQAJgZASgOIAfgPQARgIAPgDQgGAEgZAKIgeAOQgRANgJAZQgKAggQAoIgMAdQACgKAHgUg");
	this.shape_1.setTransform(-37.175,129.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#ABD082").s().p("AEVKPIknqvIkSqBQhGijgmhjQAyBsBACXIEUKBIEnKvQBdDcAYBAQgkhKhZjPg");
	this.shape_2.setTransform(-67.25,25.625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#69AF50","#69AF50","#5E9C4A","#579047","#558C46"],[0,0.004,0.329,0.659,1],-81.1,1.4,81.1,-1.4).s().p("AskFmIAsh6QADgKAjgSIAUgJIAYgJQABAEARgFQARgGADgHIWgoaQAJgDgHAHQgGAHgKAEI3VIuQgQAGgDAHIguB5QgCAFAQgFIWEocQAEgBABABQABAAAAAAQAAAAAAABQAAAAAAABQgBAAAAABQgBACgDACQgGAEgFABI1EIEQABgEgRAFQgRAGgDAHIgoAOIgNADIgDAAQgKAAACgGg");
	this.shape_3.setTransform(37.0009,101.6229);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D9D9C7").s().p("Aq+EQQAJgigJgWIWdoZQg8AkgdAbQglAjgBAeI0+IDQAWgQAKgig");
	this.shape_4.setTransform(38.075,100.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#9E9087").s().p("AgKAmQAQgVADgSQAEgUgBgRIgCgOIAGgCQAMAPgCAdQgGAggSAUIgRAJIgLAEQAIgHAIgKg");
	this.shape_5.setTransform(-33.8417,127.675);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#8D8477","#050303"],[0,1],2.3,1.6,-3,-4.1).s().p("AgiAFQAEgLAGgMQAMgYAKgDIAcgIIAGAIQAEALgCAMQgGApgbAbQgGAIgEAAg");
	this.shape_6.setTransform(-35.4692,127.775);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#82BE4E","#5E9D4C"],[0,1],-111,1.9,111.4,-2).s().p("AxjsQIUTktIAFABIOvZfIgEABI2gIag");
	this.shape_7.setTransform(5.025,10.5917);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#5E9D4C","#68A64C","#79B44D","#84BD4E","#88C04E"],[0,0.133,0.424,0.71,1],-1.2,0.6,1.7,-0.6).s().p("AF/OwIgDgCIsd9RQAHAFAMgDQALgEADgKIMidOIgEAGQgDACgLAFQgKAEgGAAIgBAAg");
	this.shape_8.setTransform(-68.875,26.4525);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#82BE4E","#72AF4D","#63A24C","#5E9D4C"],[0,0.306,0.702,1],-5,1.2,1.3,-1.4).s().p("AmEsgIgBgEIgCjFIMPdXIgsB5IAAADg");
	this.shape_9.setTransform(-78.275,37.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#5E9D4C","#85BF4E","#B8D797","#85BF4E","#74B94F"],[0,0.251,0.455,0.761,1],-4.3,1.3,3.6,-2).s().p("AmwuVQAAgQAWgOQAVgNAYgBIMedVQgSAHgTAJQgnASgGAMg");
	this.shape_10.setTransform(-74.1755,29.05);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#74B94F","#69A548","#507B3A","#3C582E","#2D3D25","#22291F","#1C1E1B","#1A1A1A"],[0,0.063,0.216,0.369,0.522,0.678,0.835,1],2.1,2.3,-3.7,-12.4).s().p("Aq3EmIgoiGIWlnHIAaAvI2KIfIgIABQgBAAgBAAQgBAAAAgBQgBAAAAAAQgBAAAAgBg");
	this.shape_11.setTransform(29.325,106.8818);

	this.instance = new lib.book01_floating();
...
p.nominalBounds = new cjs.Rectangle(-117.4,-98,234.9,236);
...
if (reversed == null) { reversed = false; }
	...
	this.button_1.setTransform(480,320,0.4587,0.4587);
	new cjs.ButtonHelper(this.button_1, 0, 1, 2, false, new lib.play(), 3);
...
// library properties:
lib.properties = {
	id: '8474F6AD61D52042884AF562C12EE96C',
	width: 960,
	height: 640,
	fps: 25,
	color: "#FFFFFF",
...
an.compositions['8474F6AD61D52042884AF562C12EE96C'] = {
